...
const messageTypeIcons: Record<MessageType, React.ReactNode> = {
  ...
  'task.assigned': <Activity className="w-4 h-4" />,
  ...
  'agent.status': <Activity className="w-4 h-4" />,
...
const messageTypeColors: Record<MessageType, string> = {
  ...
  'task.assigned': 'bg-orange-100 text-orange-700',
  ...
  'agent.status': 'bg-teal-100 text-teal-700',
